...
def main():
    parser = argparse.ArgumentParser(
        description="Keras MNIST Example - training CNN classification model"
    )
    parser.add_argument(
        "--batch-size",
        type=int,
    ...
    parser.add_argument(
        "--epochs", type=int, default=20, help="number of epochs to train (default: 6)"
    )
    ...
    task = Task.init(
        project_name="Examples emilio",
        task_name="Keras MNIST serve example",
        output_uri=True,
    )
